...
daily_sync_2026-07-31.log: sync_outcome=degraded — refusing to start: memory compressor holds 18.3 GB, ceiling is 16.0 GB (the machine is already under real pressure)

## Raw signal

```
log: /Users/noelsaw/Documents/rebalance-OS/temp/logs/daily_sync_2026-07-31.log
...
unsuppressed errors:
  - refusing to start: memory compressor holds 18.3 GB, ceiling is 16.0 GB (the machine is already under real pressure)
  - refusing to start: memory compressor holds 18.6 GB, ceiling is 16.0 GB (the machine is already under real pressure)
```
