...
### 2026-07-06
- [ ] File a distinct GH issue for Seam #4 (XYZ disposition overlay) so it's trackable independently of GH-102's phase list, mirroring how Seams #1-#3 map to their own scope.
