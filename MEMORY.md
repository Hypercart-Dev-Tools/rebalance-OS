...
- `experimental/git-pulse/report.py` is the readable export layer for saved combined TSV files; keep the TSV canonical and generate static HTML on top with `git-pulse-report <input.tsv> --output <report.html>`.
