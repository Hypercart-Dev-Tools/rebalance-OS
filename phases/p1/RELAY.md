...
<!-- marathon-drive: task=MARATHON-P1-TURN builder=claude reviewer=codex round-cap=5 -->
...
3. Use this exact tick binary (run it from any directory): /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick
   - /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick claim MARATHON-P1-TURN --agent claude --paths "phases/p1/RELAY.md,src/rebalance/ingest/index_ops.py,tests/test_index_ops.py"
   - /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick ping MARATHON-P1-TURN --agent claude
   - /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick release MARATHON-P1-TURN --agent claude --to codex
...
2. If changes needed: add `**Verdict:** Changes requested` then: /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick release MARATHON-P1-TURN --agent codex --to claude
