...
<!-- marathon-drive: task=MARATHON-VB5-TURN builder=agy reviewer=codex round-cap=7 -->
...
3. Use this exact tick binary (run it from any directory): /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick
   - /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick claim MARATHON-VB5-TURN --agent agy --paths "phases/gh250-vector-bloat-resume--vb5/RELAY.md,utils/gh250/reclaim.py,utils/gh250/rehearse.sh,tests/test_gh250_reclaim.py"
...
4. Edit ONLY these paths: phases/gh250-vector-bloat-resume--vb5/RELAY.md and utils/gh250/reclaim.py,utils/gh250/rehearse.sh,tests/test_gh250_reclaim.py. Do NOT run git. Do NOT touch any other file — the harness commits for you.
...
4. Use this exact tick binary (run it from any directory) for all token operations: /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick
   Edit ONLY phases/gh250-vector-bloat-resume--vb5/RELAY.md (your review block + STATUS). Do NOT edit the artifact yourself — request changes instead. Do NOT run git.
