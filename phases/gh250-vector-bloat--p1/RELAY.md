...
3. Use this exact tick binary (run it from any directory): /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick
   - /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick claim MARATHON-P1-TURN --agent agy --paths "phases/gh250-vector-bloat--p1/RELAY.md,src/rebalance/ingest/github_direct_commits.py,src/rebalance/ingest/db/github.py,tests/test_github_direct_commits.py"
...
4. Edit ONLY these paths: phases/gh250-vector-bloat--p1/RELAY.md and src/rebalance/ingest/github_direct_commits.py,src/rebalance/ingest/db/github.py,tests/test_github_direct_commits.py. Do NOT run git. Do NOT touch any other file — the harness commits for you.
...
4. Use this exact tick binary (run it from any directory) for all token operations: /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick
   Edit ONLY phases/gh250-vector-bloat--p1/RELAY.md (your review block + STATUS). Do NOT edit the artifact yourself — request changes instead. Do NOT run git.
