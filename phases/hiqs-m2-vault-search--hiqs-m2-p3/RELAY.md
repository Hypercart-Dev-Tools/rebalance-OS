...
3. Use this exact tick binary (run it from any directory): /Users/noelsaw/Documents/GitHub-Repos/rebalance-OS/.xyz/bin/tick
   - /Users/noelsaw/Documents/GitHub-Repos/rebalance-OS/.xyz/bin/tick claim MARATHON-HIQS-M2-P3-TURN --agent agy --paths "phases/hiqs-m2-vault-search--hiqs-m2-p3/RELAY.md,HiQS/hiqs/search.py,HiQS/tests/test_search.py"
...
4. Edit ONLY these paths: phases/hiqs-m2-vault-search--hiqs-m2-p3/RELAY.md and HiQS/hiqs/search.py,HiQS/tests/test_search.py. Do NOT run git. Do NOT touch any other file — the harness commits for you.
...
4. Use this exact tick binary (run it from any directory) for all token operations: /Users/noelsaw/Documents/GitHub-Repos/rebalance-OS/.xyz/bin/tick
   Edit ONLY phases/hiqs-m2-vault-search--hiqs-m2-p3/RELAY.md (your review block + STATUS). Do NOT edit the artifact yourself — request changes instead. Do NOT run git.
