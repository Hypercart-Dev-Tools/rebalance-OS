...
<!-- marathon-drive: task=MARATHON-COLL-P3-138-JOB-LIVENESS-TURN-2 builder=codex reviewer=agy round-cap=5 -->
...
3. Use this exact tick binary (run it from any directory): /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick
   - /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick claim MARATHON-COLL-P3-138-JOB-LIVENESS-TURN-2 --agent codex --paths "phases/marathon-2026-07-18-collectors-resume-p3--coll-p3-138-job-liveness/RELAY.md,src/rebalance/doctor.py"
   - /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick ping MARATHON-COLL-P3-138-JOB-LIVENESS-TURN-2 --agent codex
   - /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick release MARATHON-COLL-P3-138-JOB-LIVENESS-TURN-2 --agent codex --to agy
4. Edit ONLY these paths: phases/marathon-2026-07-18-collectors-resume-p3--coll-p3-138-job-liveness/RELAY.md and src/rebalance/doctor.py. Do NOT run git. Do NOT touch any other file — the harness commits for you.
...
2. If changes needed: add `**Verdict:** Changes requested` then: /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick release MARATHON-COLL-P3-138-JOB-LIVENESS-TURN-2 --agent agy --to codex
3. If satisfied: add `**Verdict:** Approved`, set `STATUS: Approved`, then: /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick done MARATHON-COLL-P3-138-JOB-LIVENESS-TURN-2 --agent agy
4. Use this exact tick binary (run it from any directory) for all token operations: /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick
   Edit ONLY phases/marathon-2026-07-18-collectors-resume-p3--coll-p3-138-job-liveness/RELAY.md (your review block + STATUS). Do NOT edit the artifact yourself — request changes instead. Do NOT run git.
