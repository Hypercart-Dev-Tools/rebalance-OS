...
<!-- marathon-drive: task=MARATHON-P5-TURN builder=agy reviewer=codex round-cap=7 -->
...
3. Use this exact tick binary (run it from any directory): /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick
   - /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick claim MARATHON-P5-TURN --agent agy --paths "phases/gh250-vector-bloat--p5/RELAY.md,utils/gh250/reclaim.py,utils/gh250/rehearse.sh,tests/test_gh250_reclaim.py"
   - /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick ping MARATHON-P5-TURN --agent agy
   - /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick release MARATHON-P5-TURN --agent agy --to codex
4. Edit ONLY these paths: phases/gh250-vector-bloat--p5/RELAY.md and utils/gh250/reclaim.py,utils/gh250/rehearse.sh,tests/test_gh250_reclaim.py. Do NOT run git. Do NOT touch any other file — the harness commits for you.
...
2. If changes needed: add `**Verdict:** Changes requested` then: /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick release MARATHON-P5-TURN --agent codex --to agy
3. If satisfied: add `**Verdict:** Approved`, set `STATUS: Approved`, then: /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick done MARATHON-P5-TURN --agent codex
4. Use this exact tick binary (run it from any directory) for all token operations: /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick
   Edit ONLY phases/gh250-vector-bloat--p5/RELAY.md (your review block + STATUS). Do NOT edit the artifact yourself — request changes instead. Do NOT run git.
