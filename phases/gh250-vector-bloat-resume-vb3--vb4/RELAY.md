...
3. Use this exact tick binary (run it from any directory): /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick
   - /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick claim MARATHON-VB4-TURN --agent agy --paths "phases/gh250-vector-bloat-resume-vb3--vb4/RELAY.md,utils/gh250/fence-writers.sh,tests/test_gh250_fencing.py"
...
4. Edit ONLY these paths: phases/gh250-vector-bloat-resume-vb3--vb4/RELAY.md and utils/gh250/fence-writers.sh,tests/test_gh250_fencing.py. Do NOT run git. Do NOT touch any other file — the harness commits for you.
...
4. Use this exact tick binary (run it from any directory) for all token operations: /Users/noelsaw/Documents/rebalance-OS/.xyz/bin/tick
   Edit ONLY phases/gh250-vector-bloat-resume-vb3--vb4/RELAY.md (your review block + STATUS). Do NOT edit the artifact yourself — request changes instead. Do NOT run git.
