...
- `Apple Reminders unified integration plan` — consolidated three Apple Reminders references into one actionable phased plan with explicit QA gates and collector-first architecture (`apple_reminders` source). → [PROJECT/2-WORKING/APPLE-REMINDERS-UNIFIED-PLAN.md](PROJECT/2-WORKING/APPLE-REMINDERS-UNIFIED-PLAN.md)
